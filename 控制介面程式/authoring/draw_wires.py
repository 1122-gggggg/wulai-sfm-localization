...
Controls (while the operator is running):
  ALT+LEFT DRAG        orbit the view
  ALT+SHIFT+LEFT DRAG  pan the view
...
class WIRE_OT_draw(bpy.types.Operator):
    ...
    def _status(self, context):
        ...
        msg += "  |  Alt+drag=orbit  Alt+Shift+drag=pan  Wheel=sag  Z=undo  S=save  Enter/Esc=finish"
...
def register():
    ...
    print("[wires] registered. Press F3 and choose 'Draw Catenary Wires' to start drawing.")
